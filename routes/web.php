...
Route::middleware(['auth', 'verified', 'setting'])->group(function () {
    ...
    Route::middleware('plan.access')->group(function () {
        ...
        Route::middleware('permission:manage-employees')->group(function () {
            ...
            Route::post('hr/employees/{employee}/documents', [EmployeeController::class, 'storeDocument'])->middleware('permission:edit-employees')->name('hr.employees.documents.store');
        ...
        Route::middleware('permission:manage-candidates')->group(function () {
            ...
            Route::post('hr/recruitment/candidates/{candidate}/send-offer', [\App\Http\Controllers\CandidateController::class, 'sendOffer'])->middleware('permission:edit-candidates')->name('hr.recruitment.candidates.send-offer');
