    ...
    >
      <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 ease-in-out">
        ...
        <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          <Card className="p-4 border-l-4 border-l-blue-500 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-sm font-medium text-muted-foreground">{t('Total Employees')}</p>
                <p className="text-2xl font-bold mt-1 text-blue-600">{stats.totalEmployees}</p>
                {isCompanyUser && (
          ...
          <Card className="p-4 border-l-4 border-l-green-500 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-2xl font-bold mt-1 text-green-600">{stats.totalBranches}</p>
          ...
          <Card className="p-4 border-l-4 border-l-purple-500 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-sm font-medium text-muted-foreground">{t('Attendance Rate')}</p>
                <p className="text-2xl font-bold mt-1 text-purple-600">{stats.attendanceRate}%</p>
          ...
          <Card className="p-4 border-l-4 border-l-amber-500 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-2xl font-bold mt-1 text-amber-600">{stats.pendingLeaves}</p>
          ...
          <Card className="p-4 border-l-4 border-l-orange-500 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-sm font-medium text-muted-foreground">{t('Active Jobs')}</p>
                <p className="text-2xl font-bold mt-1 text-orange-600">{stats.activeJobPostings}</p>
          ...
          <Card className="p-4 border-l-4 border-l-indigo-500 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-sm font-medium text-muted-foreground">{t('Total Candidates')}</p>
                <p className="text-2xl font-bold mt-1 text-indigo-600">{stats.totalCandidates}</p>
              ...
              {recentActivities.leaves.length > 0 ? (
                <div className="space-y-3 max-h-80 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 pr-2">
                  {recentActivities.leaves.map((leave, index) => (
                    <div key={index} className="flex items-center justify-between p-3 border rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
