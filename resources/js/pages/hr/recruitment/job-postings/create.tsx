...
export default function CreateJobPosting() {
  ...
  return (
    <PageTemplate
      title={t('Create Campaign - Job Posting')}
      description={t('Create a new job posting campaign')}
      url={route('hr.recruitment.job-postings.create')}
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end space-x-2">
          ...
          <Button type="submit" disabled={processing}>
            {processing ? t('Creating...') : t('Create Campaign - Job Posting')}
          </Button>
        </div>
      </form>
    </PageTemplate>
