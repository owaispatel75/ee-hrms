...
export default function EditJobPosting() {
  ...
  const breadcrumbs = [
    ...
    { title: t('Campaign - Job Postings'), href: route('hr.recruitment.job-postings.index') },
    { title: t('Edit') }
  ];

  return (
    <PageTemplate
      title={t('Edit Campaign - Job Posting')}
      description={t('Edit job posting campaign details')}
      url={route('hr.recruitment.job-postings.edit', jobPosting.id)}
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => {
                      if (checked) {
                        ...
                        setData('custom_question', data.custom_question.filter((id: any) => id !== question.id));
                      }
                    }}
                  />
                  ...
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => {
                      if (checked) {
                        ...
                        setData('applicant', data.applicant.filter((key: any) => key !== item.key));
                      }
                    }}
                  />
                  ...
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => {
                      if (checked) {
                        ...
                        setData('visibility', data.visibility.filter((key: any) => key !== item.key));
                      }
                    }}
                  />
        ...
        <div className="flex justify-end space-x-2">
          ...
          <Button type="submit" disabled={processing}>
            {processing ? t('Updating...') : t('Update Campaign - Job Posting')}
          </Button>
        </div>
      </form>
    </PageTemplate>
