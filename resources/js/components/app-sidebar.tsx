...
//                             {(() => {
//                                 // Sidebar is always dark (#1F3A8A), so always use the light logo
//                                 const currentLogo = logoLight || logoDark;
...
//                                         onError={() => updateBrandSettings({ logoLight: '' })}
//                                     />
//                                 ) : (
//                                     <div className="h-6 text-inherit font-semibold flex items-center text-lg tracking-tight whitespace-nowrap">
//                                         EXPERT EDGE
//                                     </div>
//                                 );
//                             })()}
...
//                         <div className="h-5 w-5 hidden group-data-[collapsible=icon]:block">
//                             {(() => {
...
//                                     />
//                                 ) : (
//                                     <div className="size-5 bg-sidebar-primary text-sidebar-primary-foreground rounded flex items-center justify-center font-bold shadow-sm">
//                                         E
//                                     </div>
//                                 );
//                             })()}
...
//             icon: Briefcase,
//         },
//         // Keep your existing Super Admin menus as-is.
//         // If you also want a trimmed Super Admin menu for ExpertEdge, tell me and I will adjust it.
//         {
//             title: t('Media Library'),
//             href: route('media-library'),
//             icon: Briefcase,
...
//         // 4) Recruitment (KEEP but trimmed hard)
//         // Keep only: Candidate Sources, Candidates, Interviews, Interview Feedback, Offer Templates, Offers
...
//         // Hidden for ExpertEdge Phase 1:
//         // Job Categories, Job Types, Job Locations, Custom Questions, Job Postings,
//         // Interview Types, Interview Rounds, Candidate Assessments, Checklists, Candidate Onboarding, Career page
...
//         // 3) HR Management (PARTIAL KEEP ONLY, as per ExpertEdge PDF)
//         // Keep: Departments, Designations, Document Types, Employees, Performance (KPI/KRA), Resignations, Terminations
...
//         // Performance (KEEP) mapping to: KPI, Parameters, Scorecards, Ranking
//         const performanceChildren: NavItem[] = [];
...
//         // Exit formalities inside HR (KEEP: Resignations, Terminations)
//         if (hasPermission(permissions, 'manage-resignations')) {
//             hrChildren.push({
//                 title: t('Resignations'),
//                 href: route('hr.resignations.index'),
...
//         // Everything else from old HR Management is intentionally hidden for ExpertEdge Phase 1:
//         // Branches, Awards, Promotions, Warnings, Trips, Complaints, Transfers, Holidays, Announcements,
...
//         // 8) Clients (ADD for ExpertEdge PDF)
//         // IMPORTANT: Adjust route and permission to match your backend.
//         // Suggested permission: "manage-clients"
//         // Suggested route: "clients.index"
...
//         // Hidden for ExpertEdge Phase 1:
//         // Contract Management, Document Management (as separate module),
//         // Meetings, Calendar, Media Library, Time Tracking, Plans, Currencies, Settings, Referral, etc.
//         // Also keep Currencies hidden in SaaS mode as you already do.

//         // If you still want Currencies visible in non-SaaS, keep this block, otherwise comment it out.
//         // if (!isSaas && hasPermission(permissions, 'manage-currencies')) {
//         //     items.push({
//         //         title: t('Currencies'),
//         //         href: route('currencies.index'),
...
//             <SidebarFooter>{/* footer removed */}</SidebarFooter>
//         </Sidebar>
//     );
// }
//new working ends
...
export function AppSidebar() {
    ...
    return (
        ...
        >
            ...
            <SidebarContent>
                <div style={sidebarStyle} className={`h-full pt-2 ${style !== 'plain' ? 'sidebar-styled' : ''}`}>
                    <NavMain items={filteredNavItems} position={effectivePosition} />
                </div>
            </SidebarContent>
