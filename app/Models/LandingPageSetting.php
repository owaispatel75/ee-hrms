...
class LandingPageSetting extends Model
{
    ...
    public static function getSettings()
    {
        ...
        if (!$settings) {
            ...
            $companyName = isSaas() ? 'EE HRMS' : 'EE HRMS';            

            $settings = self::create([
                'company_name' => $companyName,
                'contact_email' => 'support@eehrms.com',
    ...
    private static function getSaasConfig()
    {
        return [
            'sections' => [
                ...
                [
                    'key' => 'screenshots',
                    'title' => 'See EE HRMS in Action',
                    'subtitle' => 'Discover how our modern EE HRMS platform helps you manage employees, payroll, attendance, and performance — all in one place.',
                    'screenshots_list' => [
