...
class LoginRequest extends FormRequest
{
     ...
     public function authenticate(): void
    {
        ...
        // Check if user account is inactive or has passed exit deadline
        $user = Auth::user();
        ...
        if ($user->type === 'employee' && $user->employee) {
            ...
            if ($employee->date_of_exit) {
                ...
                if (now()->greaterThan($exitTime)) {
                    // Automatically inactivate user if they are logging in post-deadline
                    $user->update(['status' => 'inactive']);
                    Auth::logout();
                    throw ValidationException::withMessages([
                        'email' => __('Your access has been revoked following your exit from the company.'),
                    ]);
                }
            }
        }
